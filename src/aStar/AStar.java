                ...
                while(frontierList.size() != 0) {
                        ...
                        for(int i=0;i<current.getNeighborSize();i++){
                                ...
                                if(!frontierList.contains(neighbor)) {
                                	...
                                	// Colin McMorrow - check if newDistanceFromStart is less than or equal to neighbor.distanceFromStart.  If it is, continue from that node and sort the frontier list.
